...
class Plantillas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, titulo, descripcion, texto, enlaces, imagenes, fecha, notificacion, alerta', 'required'),
			array('id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, titulo, descripcion, texto, enlaces, imagenes, fecha, notificacion, alerta', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('enlaces',$this->enlaces,true);
